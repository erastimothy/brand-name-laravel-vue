    ...
    <div>
        <v-footer
            ...
            <v-card
                flat
                tile
                class="dark white--text text-center pt-5"
                width="100%"
                >
                <v-card-text class="white--text pt-0">
                    <v-row>
                    <v-col col="6" md="3" class="text-center">
                        <h3> Information</h3>
                        <v-divider class="mb-5"></v-divider>
                        <v-btn text color="blue-grey" @click="dialogAboutUs = true">Abous US</v-btn>
                        <v-btn text color="blue-grey" @click="dialogTnC = true">Privacy And Policy</v-btn>
                    </v-col>
                    <v-col col="6" md="3">
                        <h3> Payment Method</h3>
                        <v-divider class="mb-5"></v-divider>
                        <v-row >
                        <v-col col="6" md="4" v-for="bank in banks" v-bind:key="bank"  class="text-center justify-center">
                            <v-img :src="`/img/logo/${bank} `" class="logo-bank" max-width="250px" max-height="50px"> </v-img>
                        </v-col>
                        </v-row>
                    </v-col>
                        <v-col col="6" md="3" >
                        ...
                        <v-list-item-content>contact@brand-name.com</v-list-item-content>
                        </v-list-item>
                        <v-list-item>
                        <v-list-item-icon><v-icon >mdi-phone</v-icon> </v-list-item-icon>
                        <v-list-item-content >021 9457 6154</v-list-item-content>
                        </v-list-item>
                        <v-list-item>
                        <v-list-item-icon><v-icon>mdi-map-marker</v-icon> </v-list-item-icon>
                        <v-list-item-content>Jl. Pak benceng no 2 Jakarta</v-list-item-content>
                        </v-list-item>
                        <v-list-item>
                        <v-list-item-content>
                            <v-row>
                                <v-col col="6" md="3" v-for="icon in icons" v-bind:key="icon" >
                                    <v-icon>
                                    {{ icon }}
                                    </v-icon>
                                </v-col>
                        ...
                        <h3> Location</h3>
                        <v-divider class="mb-5"></v-divider>
                        <iframe class="location" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.815798184989!2d109.3777538144628!3d-0.06442393553104452!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e1d57422040df85%3A0x9c61d73e23db8aa0!2sToko%20baju%20lengkap!5e0!3m2!1sen!2sid!4v1606930033869!5m2!1sen!2sid" width="280" height="250" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                    </v-col>
                    </v-row>
                </v-card-text>
                ...
                {{ new Date().getFullYear() }} — <a href="https://instagram.com/erastimothy_"><strong>Eras Timothy</strong></a>
                </v-card-text>
            </v-card>
        </v-footer>
        <v-dialog
        v-model="dialogAboutUs"
        width="500"
        >
        ...
        >
            <v-card>
            <v-card-title>
                <span class="headline">Terms and Condition ?</span>
            </v-card-title>
            <v-card-text>
